     ...
     <View style={styles.container}>
      <ScrollView ref={(scrollView) => { _scrollView = scrollView; }}
        ...
        <Text style={styles.boldText}>
          Anna kouluarvosana tapahtumalle (1-5):
        </Text>
          <RadioForm
            style={styles.button}
        ...
        <Text style={styles.boldText}>
          Muuttuiko käsityksesi IT-alasta?
        </Text>
          <RadioForm
            style={styles.button}
            radio_props={radio_props}
        ...
        <Text style={styles.boldText}>
          Voisitko kuvitella meneväsi IT-alalle töihin?
        </Text>
          <RadioForm
            style={styles.button}
            radio_props={radio_props}
        ...
        <Text style={styles.boldText}>
          Kehitysehdotuksia seuraavan Super-Ada -tapahtuman järjestäjille?
        </Text>
          <View style={styles.inputs}>
            <View style={styles.inputContainer}>
              <TextInput
